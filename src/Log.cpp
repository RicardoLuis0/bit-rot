...
static void FilterLog(size_t i)
{
...
static void AddLog(log_item_t && orig_log)
{
...
void Log::LogFull(LogPriority priority, std::string_view fn_namespace, std::string_view fn_name, std::string_view file_name, int line, const char *fmt, ...)
{
    time_t timestamp = time(NULL);
...
void Log::LogFull(LogPriority priority, std::string_view fn_namespace, std::string_view fn_name, std::string_view file_name, int line, const std::string &msg)
{
    time_t timestamp = time(NULL);
...
void Log::LogFull(LogPriority priority, std::string_view fn_namespace, std::string_view fn_name, std::string_view file_name, int line, std::string_view msg)
{
    time_t timestamp = time(NULL);
